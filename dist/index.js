...
var use_gesture_react_esm = __webpack_require__(9);
...
function useColumnDragState(fields, initialAssignments, onTouched) {
    ...
    const bindDrag = Object(use_gesture_react_esm["useDrag"])(({ first, last, movement, xy, args, currentTarget }) => {
        if (first) {
            ...
            setDragState({
                pointerStartInfo: {
                    initialClientRect: currentTarget instanceof HTMLElement
...
const ColumnDragObject_ColumnDragObject = ({ dragState }) => {
    ...
    Object(external_react_["useLayoutEffect"])(() => {
        if (dragState) {
            dragState.updateListeners['dragObj'] = (movement) => {
...
const TargetBox = ({ hasHeaders, field, touched, assignedColumn, dragState, eventBinder, onHover, onAssign, onUnassign }) => {
    ...
    return (external_react_default.a.createElement("section", { className: "CSVImporter_ColumnDragTargetArea__box", "aria-label": field.isOptional
            ...
            : l10n.getDragTargetRequiredCaption(field.label), ref: containerRef, onPointerEnter: () => onHover(field.name, true), onPointerLeave: () => onHover(field.name, false) },
